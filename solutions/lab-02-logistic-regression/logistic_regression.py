...
def loss(y_true, y_pred):
    ...
    """
    # Serve fare la media e non solo la somma perché in questo caso sto calcolando la perdita empirica.
    # Nota infatti che il testo della funzione richiede il calcolo della AVERAGE binary cross entropy.
